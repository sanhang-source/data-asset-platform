  ...
  return (
    <ConfigProvider locale={zhCN}>
      <div className="field-management">
        ...
        >
          {/* 库表信息 */}
          <Descriptions title="库表信息" bordered column={2} className="info-descriptions" style={{ marginBottom: 24 }}>
            <Descriptions.Item label="库表中文名">工商照面</Descriptions.Item>
            <Descriptions.Item label="库表英文名">sz_business_license</Descriptions.Item>
            <Descriptions.Item label="存储环境">政务云</Descriptions.Item>
            <Descriptions.Item label="数据来源">上海生腾数据科技有限公司</Descriptions.Item>
          </Descriptions>

          {/* 字段信息 */}
          <Title level={5} className="form-section-title">字段信息</Title>
