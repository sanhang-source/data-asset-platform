...
const InterfaceFieldManagement = () => {
  ...
  const filteredFields = fields.filter(f =>
    f.fieldNameCn.toLowerCase().includes(searchText.toLowerCase()) ||
    f.fieldNameEn.toLowerCase().includes(searchText.toLowerCase())
  )

  return (
    <ConfigProvider locale={zhCN}>
      <div className="interface-field-management">
        <Card
          title={
            <Space>
        ...
        >
          {/* 接口信息 */}
          <Descriptions title="接口信息" bordered column={2} className="info-descriptions" style={{ marginBottom: 24 }}>
            <Descriptions.Item label="接口中文名">企业工商详情</Descriptions.Item>
            <Descriptions.Item label="接口英文名">enterprise_business_detail</Descriptions.Item>
            <Descriptions.Item label="存储环境">政务云</Descriptions.Item>
            <Descriptions.Item label="数据来源">上海生腾数据科技有限公司</Descriptions.Item>
          </Descriptions>

          {/* 字段列表 */}
          <Title level={5} className="form-section-title">字段列表</Title>
...
export default InterfaceFieldManagement
